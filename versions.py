...
VERSION_0_2_0 = Version(
    notes=[
        ...
        (
            "On VersioningSerializer subclasses, we now import the Transforms directly using "
        ...
        (
            "VersioningSerializer.__init__ checks that transforms have been imported. This means "
